        ...
        <div class="box-body box-profile">
          ...
          <ul class="list-group list-group-unbordered">
            ...
            <li class="list-group-item">
              <b>Type</b> <a class="pull-right"><?= $kelas->type; ?></a>
            </li>
            <li class="list-group-item">
              <b>Jumlah Soal</b> <a class="pull-right"><?= $kelas->jumlah_soal ?></a>
            </li>
            <li class="list-group-item">
              <b>Waktu Pengerjaan</b> <a class="pull-right"><?= $kelas->waktu ?></a>
            </li>
            <li class="list-group-item">
              <b>Harga</b> <a class="pull-right"><?= $kelas->harga ?></a>
            </li>
