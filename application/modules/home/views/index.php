...
<head>
    ...
    <link href="<?= base_url('assets/home/'); ?>css/carousel.css" rel="stylesheet">
</head>

<body>
    <nav class="navbar navbar-expand-md navbar-white bg-white shadow">
        <div class="container">
            <a class="navbar-brand" href="#"><img src="<?= base_url('assets/home/'); ?>img/logo.png" width="100px" alt=""></a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#"><strong> Disabled</strong></a>
                    </li>
                </ul>
    ...
    <div id="myCarousel" class="carousel slide" style="" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active" style="background-image: url('<?= base_url('assets/home/'); ?>img/avatar.jpg');">
                <div class="container">
            ...
            <div class="carousel-item" style="background-image: url('<?= base_url('assets/home/'); ?>img/avatar.jpg');">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Another example headline.</h1>
                        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                        <p><a class="btn btn-warning shadow-sm" href="#" role="button">Learn more <i class="fa fa-angle-right"></i></a></p>
                    </div>
                </div>
            </div>
            <div class="carousel-item" style="background-image: url('<?= base_url('assets/home/'); ?>img/avatar.jpg');">
                <div class="container">
                    <div class="carousel-caption text-right">
                        ...
                        <p>Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
                        <p><a class="btn btn-warning shadow-sm" href="#" role="button">Browse gallery <i class="fa fa-angle-right"></i></a></p>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    window.jQuery || document.write('<script src="<?= base_url('assets/home/'); ?>js/jquery.slim.min.js"><\/script>')
</script>
